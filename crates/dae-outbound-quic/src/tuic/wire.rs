...
pub struct TuicAuthenticateFrame {
    pub version: u8,
    pub uuid: [u8; 16],
    pub token: [u8; TUIC_AUTH_TOKEN_LEN],
}
...
pub fn parse_uuid(input: &str) -> Result<[u8; 16], OutboundError> {
...
pub fn build_authenticate_frame(uuid: [u8; 16], token: [u8; TUIC_AUTH_TOKEN_LEN]) -> Vec<u8> {
...
pub fn parse_authenticate_frame(input: &[u8]) -> Result<TuicAuthenticateFrame, OutboundError> {
...
pub fn build_connect_frame(target: &str) -> Result<Vec<u8>, OutboundError> {
...
pub fn parse_packet_frame(input: &[u8]) -> Result<TuicUdpPacket, OutboundError> {
