...
#[test]
fn runtime_runner_outbound_vmess_commands_match_fixture() {
    let fixture = load("outbound/protocol/vmess_rust_native.json");
...
#[test]
fn runtime_runner_outbound_vless_commands_match_fixture() {
    let fixture = load("outbound/protocol/vless_rust_native.json");
