...
pub(super) fn run_transport_contract() -> RunnerOutput {
    RunnerOutput::ok(format!(
        "{}\n",
        json!({
            "name": "shared-transport-rust-native",
            ...
            "grpc_transport": {
                ...
                "sample_cache_key_a": shared_transport::ir::grpc_cache_key("addr:443", "sni.fixture.invalid", "dialer-1", true, 1234, true),
                "sample_cache_key_b": shared_transport::ir::grpc_cache_key("addr:443", "sni.fixture.invalid", "dialer-1", true, 1234, false),
...
pub(super) fn run_transport_grpc_cache_key(args: &[String]) -> RunnerOutput {
    ...
    let server_name = string_arg(args, "--server-name").unwrap_or("sni.fixture.invalid");
...
pub(super) fn run_transport_smoke() -> RunnerOutput {
    let extra = r#"{"downloadSettings":{"address":"download.fixture.invalid","port":443,"network":"xhttp","security":"reality","xhttpSettings":{"host":"download.fixture.invalid","path":"/download","extra":"{\"xmux\":{\"maxConnections\":\"3\",\"cMaxReuseTimes\":\"9\"}}"}},"xmux":{"maxConnections":"1"},"xPaddingBytes":"100-200"}"#;
    ...
    RunnerOutput::ok(format!(
        ...
        json!({
            ...
            "grpc": {
                "cache_key": shared_transport::ir::grpc_cache_key("addr:443", "sni.fixture.invalid", "dialer-1", true, 1234, true),
                "clean_cache_hook": shared_transport::contract::GRPC_CLEAN_CACHE_HOOK,
            },
            "reality": {
