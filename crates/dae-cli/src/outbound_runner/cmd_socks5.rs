...
pub(super) fn run_socks5(args: &[String]) -> RunnerOutput {
...
pub(super) fn run_socks5_contract() -> RunnerOutput {
    let link =
...
pub(super) fn run_socks5_codec(args: &[String]) -> RunnerOutput {
...
pub(super) fn run_socks5_handshake(args: &[String]) -> RunnerOutput {
    let Some(target) = string_arg(args, "--target") else {
...
pub(super) fn run_socks5_udp_packet(args: &[String]) -> RunnerOutput {
    let Some(target) = string_arg(args, "--target") else {
...
pub(super) fn run_socks5_smoke(args: &[String]) -> RunnerOutput {
