...
pub struct Global {
    ...
    pub resident_tcp_runtime_workers: Option<u64>,
    pub resident_tcp_connection_limit: Option<u64>,
    pub resident_dns_upstream_refresh_seconds: Option<u64>,
...
impl Default for Global {
    fn default() -> Self {
        Self {
            ...
            resident_tcp_runtime_workers: None,
            resident_tcp_connection_limit: None,
            resident_dns_upstream_refresh_seconds: None,
