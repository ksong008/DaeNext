...
pub struct SubscriptionContentReport {
...
impl SubscriptionContentReport {
    pub fn from_links(links: &[String]) -> Self {
        Self {
...
pub fn parse_subscription_content(content: &str) -> SubscriptionContentReport {
...
pub fn subscription_links_from_content(content: &str) -> Vec<String> {
