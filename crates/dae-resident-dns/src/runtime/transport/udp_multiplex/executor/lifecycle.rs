...
pub struct ResidentDnsUdpActorTask {
    pub lifecycle: std::sync::Weak<ResidentDnsUdpActorLifecycle>,
    pub completion: std::sync::Arc<ResidentDnsUdpActorCompletion>,
    pub task: tokio::task::JoinHandle<bool>,
}

pub async fn join_dns_udp_actor_tasks(
