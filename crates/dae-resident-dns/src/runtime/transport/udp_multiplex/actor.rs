...
pub async fn run_udp_multiplex_actor(
    target: SocketAddr,
...
pub fn handle_udp_multiplex_response(
    pending: &mut HashMap<u16, PendingUdpRequest>,
    id_allocator: &mut DnsRequestIdAllocator,
    response: &[u8],
...
pub fn validate_and_restore_udp_multiplex_response(
...
pub fn expire_pending_udp_requests(
    pending: &mut HashMap<u16, PendingUdpRequest>,
    deadlines: &mut VecDeque<PendingUdpDeadline>,
    id_allocator: &mut DnsRequestIdAllocator,
    metrics: &ResidentDataplaneMetrics,
...
pub fn next_udp_multiplex_deadline(
    deadlines: &mut VecDeque<PendingUdpDeadline>,
