...
use dae_resident_transport::{
    inherit_quic_endpoint_observation, wait_quic_endpoint_idle_after_close_for,
};
...
fn quic_endpoint_context_for_proxy(
    ...
    default_generation: dae_runtime_control::OwnerGeneration,
    proxy: &dae_resident_plan::ResidentProxyPlan,
...
pub async fn shutdown_cached_dns_quic(
    forwarder: Arc<AsyncMutex<ResidentDnsQuicForwarder>>,
...
pub async fn forward_dns_quic_async(
...
pub struct DnsQuicEndpointConnectContract {
...
pub async fn connect_dns_quic_endpoint_async(
...
pub fn configured_dns_quic_endpoint_context(
    protocol: QuicEndpointProtocol,
    upstream: &ResidentDnsUpstream,
    generation: u64,
) -> QuicEndpointOpenContext {
...
pub fn managed_dns_quic_endpoint_context(
    protocol: QuicEndpointProtocol,
    upstream: &ResidentDnsUpstream,
    remote: SocketAddr,
