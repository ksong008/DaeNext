use super::super::upstream_model::ResidentDnsTargetRefreshError;
use super::super::*;
use super::ResidentDnsTransportError;
use futures_util::{StreamExt, stream::FuturesUnordered};

pub async fn resolved_upstream_targets(
...
pub async fn refresh_dns_upstream_targets(
...
pub struct ResidentDnsUpstreamCandidate {
    pub target: SocketAddr,
    pub l4proto: L4Proto,
}

#[derive(Clone, Debug)]
pub struct ResidentDnsUpstreamRoutedTarget {
    pub target: SocketAddr,
...
pub fn dns_upstream_candidates_for_l4protos(
    targets: &[SocketAddr],
    l4protos: &[L4Proto],
...
pub fn select_dns_upstream_targets(
    plan: &ResidentDnsPlan,
    upstream: &ResidentDnsUpstream,
...
pub fn select_dns_upstream_candidates(
    plan: &ResidentDnsPlan,
    upstream: &ResidentDnsUpstream,
...
pub fn dns_upstream_targets_failed(
    upstream: &ResidentDnsUpstream,
    operation: &str,
    failures: Vec<String>,
) -> String {
...
pub async fn race_dns_upstream_targets_with_refresh<F, Fut, R, RFut>(
    upstream: &ResidentDnsUpstream,
