...
pub struct ResidentDnsTcpUdpHedgeRegistry {
...
impl ResidentDnsTcpUdpHedgeRegistry {
    pub fn delay(&self, upstream_index: u8, profile: ResidentDnsTcpUdpHedgeProfile) -> Duration {
        self.entries[usize::from(upstream_index)].delay(profile)
    }

    pub fn record_udp_success(
        &self,
        upstream_index: u8,
        elapsed: Duration,
    ...
    pub fn record_udp_failure(&self, upstream_index: u8) {
