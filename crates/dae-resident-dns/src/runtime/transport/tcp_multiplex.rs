...
#[derive(Clone)]
pub struct ResidentDnsTcpMultiplexHandle {
...
pub struct ResidentDnsTcpMultiplexRegistration {
...
impl ResidentDnsTcpMultiplexHandle {
    pub fn new(capacity: usize) -> (Self, ResidentDnsTcpMultiplexRegistration) {
...
impl ResidentDnsTcpMultiplexRegistration {
    pub async fn run(self, stream: TokioTcpStream) -> Result<(), String> {
