...
use dae_resident_core::{
    Hysteria2OwnerResourceProfile, RESIDENT_RUNTIME_RESOURCE_DRAIN_GRACE,
    ResidentUdpPayloadAdmission, ResidentUdpPayloadPermit, SharedResidentStopSignal,
};
#[cfg(test)]
use dae_resident_core::{
...
use crate::quic_connections::{
    Hysteria2QuicConnectionRequest, ResidentConnectedQuicEndpoint,
...
pub fn hysteria2_owner_identity_digest_for_test(binding: &ResidentProxyBinding) -> [u8; 32] {
    Hysteria2OwnerKey::for_binding(binding).digest
}
...
pub struct Hysteria2SharedTransport {
    instance_id: u64,
...
impl Hysteria2SharedTransport {
    ...
    pub fn auth_report(&self) -> &Hysteria2AuthReport {
        &self.auth_report
    }
...
pub struct Hysteria2TransportLease {
...
impl Hysteria2TransportLease {
    ...
    pub fn open_udp_session(self) -> Result<Hysteria2UdpSessionLease, String> {
...
pub struct Hysteria2UdpSessionLease {
...
impl Hysteria2UdpSessionLease {
    ...
    pub fn try_receive(&mut self) -> Result<Option<Hysteria2UdpMessage>, String> {
...
#[derive(Clone)]
pub struct Hysteria2OwnerRegistryHandle {
    generation: OwnerGeneration,
...
impl Hysteria2OwnerRegistryHandle {
    #[cfg(any(test, feature = "test-support"))]
    pub fn resource_profile_for_test(&self) -> Hysteria2OwnerResourceProfile {
        self.resources
    }
...
pub fn start_hysteria2_owner_registry(
    generation: u64,
...
pub fn start_hysteria2_owner_registry_on(
