...
#[derive(Clone)]
pub struct H2CarrierGenerationOwnerHandle {
...
impl H2CarrierLease {
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub async fn current_max_send_streams(&self) -> usize {
...
pub struct H2CarrierResponseFuture {
...
#[cfg(any(test, feature = "test-support"))]
pub fn start_h2_carrier_generation_owner(
    generation: u64,
...
pub fn start_h2_carrier_generation_owner_on(
    runtime: &tokio::runtime::Handle,
    generation: u64,
    stop: SharedResidentStopSignal,
    runtime_worker_threads: usize,
...
pub async fn acquire_h2_carrier(
