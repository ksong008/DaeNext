...
pub struct TuicSharedTransport {
    instance_id: u64,
...
impl TuicSharedTransport {
    ...
    pub fn auth_report(&self) -> &TuicAuthReport {
        &self.auth_report
    }
...
impl TuicTransportLease {
    ...
    pub fn open_udp_association(self) -> Result<TuicUdpAssociationLease, String> {
...
pub struct TuicUdpAssociationLease {
...
impl TuicUdpAssociationLease {
    ...
    pub fn try_receive(&mut self) -> Result<Option<TuicUdpPacket>, String> {
...
#[derive(Clone)]
pub struct TuicOwnerRegistryHandle {
    generation: OwnerGeneration,
...
pub fn start_tuic_owner_registry(
    generation: u64,
...
pub fn start_tuic_owner_registry_with_resources(
    generation: u64,
    stop: SharedResidentStopSignal,
    stack_bytes: usize,
    resources: TuicOwnerResourceProfile,
...
pub fn start_tuic_owner_registry_on(
