...
pub async fn send_xhttp_packet_up_request(
...
pub async fn replace_xhttp_packet_up_client(upload: &mut XhttpUploadClient) -> Result<(), String> {
    match upload {
...
pub async fn begin_xhttp_packet_up_request(
    upload: &mut XhttpUploadClient,
    session_id: &str,
    seq: u64,
    payload: Bytes,
...
pub fn reserve_xhttp_packet_up_post(upload: &XhttpUploadClient) -> bool {
    match upload {
        XhttpUploadClient::H2 {
...
pub async fn read_xhttp_download_data(
    download: &mut XhttpDownloadClient,
) -> Result<Option<Bytes>, String> {
    match download {
...
pub async fn send_xhttp_stream_data(
...
pub async fn close_xhttp_stream_upload_client(mut upload: XhttpStreamUploadClient) {
    match &mut upload {
