...
pub struct XhttpH3EndpointClient {
    pub client: h3::client::SendRequest<h3_quinn::OpenStreams, Bytes>,
    pub connection: Option<XhttpH3Connection>,
...
>;
pub async fn open_xhttp_h3_proxy_client(
...
pub async fn open_xhttp_h3_endpoint_client(
    binding: &ResidentProxyBinding,
    endpoint: &ResidentXhttpEndpointPlan,
) -> Result<XhttpH3EndpointClient, String> {
    let proxy = binding.plan();
...
impl XhttpH3Connection {
    ...
    pub fn abort_with_reason(mut self, reason: &[u8]) {
...
pub fn note_xhttp_h3_stream_error(
...
pub async fn open_xhttp_h3_request(
...
pub async fn open_xhttp_h3_download_stream(
...
pub async fn replace_xhttp_h3_packet_up_client(
    binding: &ResidentProxyBinding,
    endpoint: &ResidentXhttpEndpointPlan,
    client: &mut h3::client::SendRequest<h3_quinn::OpenStreams, Bytes>,
