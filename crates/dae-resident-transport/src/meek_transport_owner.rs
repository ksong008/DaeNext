...
use crate::{AsyncResidentTlsClient, open_async_resident_tls_client_with_binding};
...
#[derive(Clone)]
pub struct MeekTransportGenerationOwnerHandle {
...
impl MeekTransportLease {
    pub fn client_mut(&mut self) -> &mut AsyncResidentTlsClient {
        &mut self
            .physical
            .as_mut()
...
#[cfg(any(test, feature = "test-support"))]
pub fn start_meek_transport_generation_owner(
    generation: u64,
...
#[cfg(any(test, feature = "test-support"))]
pub fn start_meek_transport_generation_owner_for_test(
    generation: u64,
    stop: SharedResidentStopSignal,
    thread_stack_bytes: usize,
    runtime_worker_threads: usize,
...
pub fn start_meek_transport_generation_owner_on(
    runtime: &tokio::runtime::Handle,
    generation: u64,
    stop: SharedResidentStopSignal,
    runtime_worker_threads: usize,
...
pub async fn acquire_meek_transport(
