...
pub struct RuntimeTransitionIdentity {
    pub routing_version: i64,
    pub geodata_input_version: i64,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum RuntimeTransitionClass {
    NoChange,
    GenerationSwap,
    KernelRebind,
    ProcessRestart,
...
pub fn classify_runtime_transition(
    active: &Config,
...
pub fn process_owned_field_changes(active: &Config, desired: &Config) -> Vec<&'static str> {
