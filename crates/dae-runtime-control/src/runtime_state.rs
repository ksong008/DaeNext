...
impl RuntimeStateReport {
    ...
    pub fn ready_for_product_control_plane(self) -> bool {
...
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ControlPlaneProductAdmission {
    ...
    pub native_tproxy_contract_ready: bool,
}

impl ControlPlaneProductAdmission {
    pub fn admitted(self) -> bool {
        self.runtime.ready_for_product_control_plane()
            ...
            && self.cleanup_passed
            && self.restore_passed
            && self.native_tproxy_contract_ready
    }
}
