...
pub use network_defaults::{
    RESIDENT_CONNECT_TIMEOUT, RESIDENT_IDLE_SLEEP, RESIDENT_RUNTIME_RESOURCE_DRAIN_GRACE,
    RESIDENT_RUNTIME_TASK_JOIN_GRACE, RESIDENT_TCP_CANDIDATE_ATTEMPT_DELAY,
    RESIDENT_TCP_CANDIDATE_MAX_IN_FLIGHT, RESIDENT_TCP_FLOW_STACK_BYTES_DEFAULT,
