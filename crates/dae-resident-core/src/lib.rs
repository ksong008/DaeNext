...
pub use network_defaults::{
    ...
    RESIDENT_TCP_IDLE_TIMEOUT, RESIDENT_UDP_RESPONSE_TIMEOUT, TLS_RECORD_HEADER_LEN,
    TLS_RECORD_MAX_PAYLOAD_LEN, VISION_COMMAND_CONTINUE, VISION_COMMAND_DIRECT, VISION_COMMAND_END,
    VLESS_RESPONSE_VERSION, resident_udp_runtime_topology,
};
