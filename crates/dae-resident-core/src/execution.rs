...
pub struct RuntimeExecutionDescriptor {
...
impl RuntimeExecutionDescriptor {
    ...
    pub fn with_packet_semantics(mut self, packet_semantics: &str) -> Self {
        self.packet_semantics = Some(RuntimePacketSemantics::from_report_str(packet_semantics));
        self
    }

    pub fn with_security_underlay(mut self, security_underlay: &str) -> Self {
        self.security_underlay = Some(RuntimeSecurityUnderlay::from_report_str(security_underlay));
        self
    }

    pub fn with_stream_wrapper(mut self, stream_wrapper: &str) -> Self {
        self.stream_wrapper = Some(RuntimeStreamWrapper::from_report_str(stream_wrapper));
        self
    }

    pub fn with_protocol_framing(mut self, protocol_framing: &str) -> Self {
    ...
    pub fn with_transport_underlay(mut self, transport_underlay: &str) -> Self {
    ...
    pub fn with_session_ownership(mut self, session_ownership: &str) -> Self {
    ...
    pub fn with_graph_id(mut self, graph_id: &str) -> Self {
...
pub fn append_runtime_execution_descriptor(
    event: &mut Value,
...
pub fn tcp_execution_descriptor(label: &str) -> RuntimeExecutionDescriptor {
...
pub fn udp_execution_descriptor(label: &str) -> RuntimeExecutionDescriptor {
