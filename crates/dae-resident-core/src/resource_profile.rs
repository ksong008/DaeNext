...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct EffectiveProcessMemoryCapacity {
    bytes: u64,
    source: &'static str,
}
...
pub fn selected_resident_runtime_profile_name() -> &'static str {
    ResidentRuntimeProfileSelection::selected().profile.name()
}

pub fn effective_process_memory_capacity() -> Option<EffectiveProcessMemoryCapacity> {
...
pub fn resident_datapath_postflight_interval_seconds_default() -> u64 {
