...
impl UdpSessionExecutor {
    #[cfg(test)]
    pub(in crate::udp) fn new(proxy: &ResidentProxyPlan, original_dst: SocketAddr) -> Self {
    ...
    #[cfg(test)]
    pub(in crate::udp) fn new_proxy_packet(proxy: &ResidentProxyPlan) -> Self {
    ...
    pub(in crate::udp) fn new_with_transport_owner(
    ...
    pub(in crate::udp) fn new_proxy_packet_with_transport_owner(
        binding: ResidentProxyBinding,
        owner_registry: Hysteria2OwnerRegistryHandle,
        tuic_owner_registry: Option<TuicOwnerRegistryHandle>,
        juicity_owner_registry: Option<JuicityOwnerRegistryHandle>,
    ...
    pub(in crate::udp) fn new_proxy_packet_with_optional_transport_owner(
        binding: ResidentProxyBinding,
