...
#[derive(Debug)]
pub(in crate::udp) struct UdpResponseEnvelope {
    payload: Vec<u8>,
    identity: UdpResponseIdentityEvidence,
    pub(in crate::udp) execution_label: &'static str,
    pub(in crate::udp) tls_underlay: Option<&'static str>,
    pub(in crate::udp) quic_underlay: Option<&'static str>,
    pub(in crate::udp) session_executor: Option<&'static str>,
    pub(in crate::udp) underlay_reuse: Option<&'static str>,
    pub(in crate::udp) session_ownership: &'static str,
    pub(in crate::udp) reply_forwarded: bool,
}

pub(in crate::udp) type UdpExchangeResult = UdpResponseEnvelope;

impl UdpResponseEnvelope {
    pub(in crate::udp) fn new(payload: Vec<u8>, execution_label: &'static str) -> Self {
        Self {
            payload,
    ...
    pub(in crate::udp) fn pending_response(execution_label: &'static str) -> Self {
        Self {
            payload: Vec::new(),
            identity: UdpResponseIdentityEvidence::CompatibilityUnverified,
            execution_label,
    ...
    pub(in crate::udp) fn with_tls_underlay(mut self, tls_underlay: &'static str) -> Self {
        self.tls_underlay = Some(tls_underlay);
        self
    }

    pub(in crate::udp) fn with_quic_underlay(mut self, quic_underlay: &'static str) -> Self {
        self.quic_underlay = Some(quic_underlay);
        self
    }

    pub(in crate::udp) fn with_session_executor(mut self, session_executor: &'static str) -> Self {
        self.session_executor = Some(session_executor);
        self
    }

    pub(in crate::udp) fn with_underlay_reuse(mut self, underlay_reuse: &'static str) -> Self {
    ...
    pub(in crate::udp) fn fixed_target_expectation(
        &self,
        source: std::net::SocketAddr,
    ...
    pub(in crate::udp) fn take_fixed_target_payload(
        &mut self,
        expectation: UdpFixedTargetExpectation,
    ...
    #[cfg(test)]
    pub(in crate::udp) fn payload_for_test(&self) -> &[u8] {
        &self.payload
    }

    #[cfg(test)]
    pub(in crate::udp) fn with_session_ownership(
        mut self,
    ...
    pub(in crate::udp) fn append_execution_fields(
        &self,
    ...
    pub(in crate::udp) fn append_session_fields(&self, value: &mut serde_json::Value) {
