...
pub(super) fn request_action_from_index(
...
pub(super) fn request_index_for_dynamic(
...
pub(super) fn request_index_for_function(
    function: &Function,
    upstreams: &ResidentDnsUpstreams,
    context: &str,
) -> Result<DnsRequestOutboundIndex, String> {
...
pub(super) fn response_index_for_dynamic(
    value: &DynamicFunctionValue,
    upstreams: &ResidentDnsUpstreams,
    context: &str,
...
pub(super) fn response_index_for_function(
    function: &Function,
    upstreams: &ResidentDnsUpstreams,
    context: &str,
) -> Result<DnsResponseOutboundIndex, String> {
...
pub(super) fn parse_request_action_function(
    function: &Function,
...
pub(super) fn parse_response_action_function(
    function: &Function,
    upstreams: &BTreeMap<String, ResidentDnsUpstream>,
    context: &str,
...
pub(super) fn response_action_from_index(
    plan: &ResidentDnsPlan,
...
pub(super) fn dynamic_to_optional_single_function(
    value: &DynamicFunctionValue,
