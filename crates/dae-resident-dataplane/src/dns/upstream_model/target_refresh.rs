...
pub(in crate::dns) type ResidentDnsTargetRefreshOwnerTask =
...
#[derive(Clone, Debug)]
pub(in crate::dns) struct ResidentDnsTargetRefreshHandle {
...
pub(in crate::dns) struct ResidentDnsTargetRefreshOwner {
