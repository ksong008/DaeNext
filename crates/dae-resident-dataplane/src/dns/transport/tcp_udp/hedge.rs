...
pub(in crate::dns) struct ResidentDnsTcpUdpHedgeRegistry {
...
impl ResidentDnsTcpUdpHedgeRegistry {
    ...
    pub(in crate::dns) fn record_udp_success(
        &self,
        upstream_index: u8,
        elapsed: Duration,
        profile: ResidentDnsTcpUdpHedgeProfile,
    ...
    pub(in crate::dns) fn record_udp_failure(&self, upstream_index: u8) {
