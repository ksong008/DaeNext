...
pub(crate) struct DnsRequestIdAllocator {
...
impl DnsRequestIdAllocator {
    pub(crate) fn new(quarantine_duration: Duration) -> Self {
        Self {
    ...
    pub(crate) fn allocate(&mut self, capacity: usize) -> Result<u16, String> {
