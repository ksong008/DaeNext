...
#[derive(Clone)]
pub(in crate::dns) struct ResidentDnsTcpMultiplexHandle {
...
pub(in crate::dns) struct ResidentDnsTcpMultiplexRegistration {
...
impl ResidentDnsTcpMultiplexHandle {
    pub(in crate::dns) fn new(capacity: usize) -> (Self, ResidentDnsTcpMultiplexRegistration) {
    ...
    pub(in crate::dns) fn pending(&self) -> usize {
        self.active.load(Ordering::Acquire)
    }

    pub(in crate::dns) fn has_capacity(&self) -> bool {
    ...
    pub(in crate::dns) fn close(&self) {
    ...
    pub(in crate::dns) async fn wait_for_capacity(
        &self,
        context: ProxyDnsRequestContext,
...
impl ResidentDnsTcpMultiplexRegistration {
    pub(in crate::dns) async fn run(self, stream: TokioTcpStream) -> Result<(), String> {
