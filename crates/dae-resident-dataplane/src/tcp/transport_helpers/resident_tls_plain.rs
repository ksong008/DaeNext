...
pub(in crate::tcp) const TLS_PLAIN_RELAY_FLUSH_BYTES: usize = 128 * 1024;
pub(in crate::tcp) const TLS_PLAIN_RELAY_FLUSH_DELAY: Duration = Duration::from_millis(1);
...
pub(in crate::tcp) async fn flush_tls_plain_write_half<W>(
    writer: &mut W,
...
pub(in crate::tcp) fn note_pending_tls_plain_flush(
...
pub(in crate::tcp) fn tls_plain_flush_deadline(deadline: Option<Instant>) -> time::Instant {
