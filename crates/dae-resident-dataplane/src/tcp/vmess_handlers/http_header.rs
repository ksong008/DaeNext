...
pub(in crate::tcp) async fn handle_vmess_http_header_proxy_tcp_connection_async(
...
#[allow(clippy::too_many_arguments)]
pub(in crate::tcp) async fn handle_vmess_http_header_tls_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
