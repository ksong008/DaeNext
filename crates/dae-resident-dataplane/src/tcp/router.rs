...
pub(crate) struct ResidentTcpRouter {
    ...
    pub(crate) routing_tuple_map_id: u32,
    routing_tuple_map_fd: OwnedFd,
    pub(crate) routing_matcher: RoutingMatcher,
    pub(crate) dns: ResidentDnsResolver,
    pub(crate) dial_mode: TcpDialMode,
    pub(crate) sniffing_timeout: Duration,
    pub(crate) so_mark_from_dae: u32,
    pub(crate) mptcp: bool,
    pub(crate) health_resuscitation: Option<ResidentHealthResuscitationHandle>,
    pub(crate) hysteria2_owner_registry: Option<Hysteria2OwnerRegistryHandle>,
    pub(crate) tuic_owner_registry: Option<TuicOwnerRegistryHandle>,
    pub(crate) juicity_owner_registry: Option<JuicityOwnerRegistryHandle>,
    pub(crate) anytls_owner_registry: Option<AnyTlsOwnerRegistryHandle>,
}
...
impl ResidentTcpRouter {
    ...
    pub(crate) fn new_for_test(
        ...
        Self::from_open_routing_tuple_map(
            ...
            routing_tuple_map_fd,
            routing_matcher,
            ResidentDnsResolver::asis(so_mark_from_dae),
            dial_mode,
            sniffing_timeout,
            so_mark_from_dae,
            mptcp,
    ...
    #[cfg(test)]
    pub(crate) fn new_for_test_shared(
        proxies: SharedResidentProxyGroupMap,
        routing_matcher: RoutingMatcher,
        dial_mode: TcpDialMode,
        sniffing_timeout: Duration,
    ...
    pub(crate) fn dial_mode_name(&self) -> &'static str {
        self.dial_mode.as_str()
    }

    pub(crate) fn sniffing_timeout(&self) -> Duration {
    ...
    #[cfg(test)]
    pub(crate) fn select_from_routing_result(
        &self,
        peer: SocketAddr,
        original_dst: SocketAddr,
        sniffed_domain: &str,
    ...
    pub(crate) fn select_from_routing_result_with_domain_real(
        &self,
        peer: SocketAddr,
        original_dst: SocketAddr,
        sniffed_domain: &str,
    ...
    pub(crate) fn lookup_routing_result(
        &self,
        peer: SocketAddr,
        original_dst: SocketAddr,
...
pub(crate) struct TcpRouteSelection {
    pub(crate) initial_outbound: u8,
    pub(crate) final_outbound: u8,
    pub(crate) final_mark: u32,
    pub(crate) userspace_route_executed: bool,
    pub(crate) userspace_route_must: bool,
    pub(crate) dial_target: String,
    pub(crate) dial_ip: bool,
    pub(crate) log_metadata: TcpRoutingLogMetadata,
}
...
impl TcpRoutingLogMetadata {
    pub(crate) fn from_bpf(result: &BpfRoutingResult) -> Self {
        Self {
            pid: result.pid,
            dscp: result.dscp,
...
pub(crate) struct TcpProxySelection {
    pub(crate) route: TcpRouteSelection,
