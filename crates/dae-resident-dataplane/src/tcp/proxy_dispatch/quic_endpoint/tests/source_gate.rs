...
const CENTRAL_CONSTRUCTOR: &str =
    "crates/dae-resident-dataplane/src/tcp/proxy_dispatch/quic_endpoint.rs";
...
const SOURCE_GATE_TEST: &str =
    "crates/dae-resident-dataplane/src/tcp/proxy_dispatch/quic_endpoint/tests/source_gate.rs";
