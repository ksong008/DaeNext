...
pub(crate) enum AsyncResidentTcpStream {
...
pub(crate) struct TlsRecordBoundedReader<S> {
    inner: S,
...
pub(crate) struct AsyncTlsFragmentingTcpStream {
...
pub(crate) struct AsyncTlsFragmentingWriter<S> {
    inner: S,
