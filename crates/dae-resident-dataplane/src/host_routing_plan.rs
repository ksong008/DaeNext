...
pub use self::types::{MatchSetBytes, ResidentDomainSet, ResidentRoutingPlan};

#[allow(dead_code)]
pub fn build_resident_userspace_routing_matcher(
    config: &Config,
...
pub fn build_resident_userspace_routing_matcher_with_geodata(
    config: &Config,
