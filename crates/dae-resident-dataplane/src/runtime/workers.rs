...
pub struct ResidentDataplaneStartContext<'a> {
    ...
    pub config: &'a Config,
    pub config_owner: Arc<Config>,
    pub artifact_dir: &'a Path,
    pub routing_tuple_map_id: Option<u32>,
    pub domain_routing_map_id: Option<u32>,
    pub prepared: ResidentPreparedDataplane,
    pub latency_seed: &'a [Value],
    pub dns_reload_snapshot: Option<&'a ResidentDnsReloadSnapshot>,
}

pub fn start_resident_dataplane_workers(
