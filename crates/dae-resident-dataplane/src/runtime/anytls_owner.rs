...
use crate::plan::{ResidentProxyBinding, ResidentProxyPlan, ResidentProxyProtocolPlan};
...
#[derive(Clone)]
pub(crate) struct AnyTlsOwnerRegistryHandle {
    generation: OwnerGeneration,
...
pub(crate) struct AnyTlsLogicalStreamLease {
    stream: DuplexStream,
    sid: u32,
...
pub(crate) fn start_anytls_owner_registry(
    generation: u64,
...
pub(super) fn start_anytls_owner_registry_with_resources(
    generation: u64,
    stop: SharedResidentStopSignal,
    stack_bytes: usize,
    resources: AnyTlsOwnerResourceProfile,
...
mod tests {
    ...
    fn production_anytls_callers_cannot_reopen_physical_tls_directly() {
        ...
        let tcp = include_str!("../tcp/proxy_dispatch/anytls.rs");
        let udp = include_str!("../udp/session_executor/anytls.rs");
