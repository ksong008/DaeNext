...
use crate::plan::{ResidentProtocolShape, ResidentProxyBinding, ResidentStreamWrapperPlan};
...
#[derive(Clone)]
pub(crate) struct VlessMuxGenerationOwnerHandle {
...
pub(crate) struct VlessMuxLogicalStream {
    stream: DuplexStream,
    sid: u16,
...
#[cfg(test)]
pub(crate) fn start_vless_mux_generation_owner_for_test(
    generation: u64,
    stop: SharedResidentStopSignal,
    thread_stack_bytes: usize,
    runtime_worker_threads: usize,
