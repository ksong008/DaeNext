...
pub struct EbpfBackendCapabilityReport {
    ...
    pub backend_reason: Option<&'static str>,
...
pub fn report_only_ebpf_backend_capability(
    ...
    EbpfBackendCapabilityReport {
        ...
        command_backend_used: attach_plan.command_backend_used,
        backend_reason: if attach_plan.command_backend_used {
