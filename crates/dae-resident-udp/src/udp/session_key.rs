...
impl UdpSessionKey {
    pub fn new(proxy: &ResidentProxyPlan, peer: SocketAddr, original_dst: SocketAddr) -> Self {
        Self::build(proxy, peer, original_dst, None)
    }

    pub fn with_dispatch_lane(
    ...
    pub fn new_with_graph_identity_hash(
        proxy: &ResidentProxyPlan,
    ...
    pub fn with_dispatch_lane_and_graph_identity_hash(
        proxy: &ResidentProxyPlan,
        graph_identity_hash: &str,
        peer: SocketAddr,
        original_dst: SocketAddr,
...
pub fn graph_identity_hash(proxy: &ResidentProxyPlan) -> String {
