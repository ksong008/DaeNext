...
#[derive(Debug)]
pub struct UdpResponseEnvelope {
    payload: Vec<u8>,
    identity: UdpResponseIdentityEvidence,
    pub execution_label: &'static str,
    pub tls_underlay: Option<&'static str>,
    pub quic_underlay: Option<&'static str>,
    pub session_executor: Option<&'static str>,
    pub underlay_reuse: Option<&'static str>,
    pub session_ownership: &'static str,
    pub reply_forwarded: bool,
}

pub type UdpExchangeResult = UdpResponseEnvelope;

impl UdpResponseEnvelope {
    pub fn new(payload: Vec<u8>, execution_label: &'static str) -> Self {
        Self {
            payload,
    ...
    pub fn pending_response(execution_label: &'static str) -> Self {
        Self {
            payload: Vec::new(),
            identity: UdpResponseIdentityEvidence::CompatibilityUnverified,
            execution_label,
    ...
    pub fn with_tls_underlay(mut self, tls_underlay: &'static str) -> Self {
        self.tls_underlay = Some(tls_underlay);
        self
    }

    pub fn with_quic_underlay(mut self, quic_underlay: &'static str) -> Self {
        self.quic_underlay = Some(quic_underlay);
        self
    }

    pub fn with_session_executor(mut self, session_executor: &'static str) -> Self {
        self.session_executor = Some(session_executor);
        self
    }

    pub fn with_underlay_reuse(mut self, underlay_reuse: &'static str) -> Self {
        self.underlay_reuse = Some(underlay_reuse);
        self
    }

    pub fn with_decoded_response_identity(
        mut self,
    ...
    pub fn with_session_bound_response_identity(
        mut self,
    ...
    pub fn with_session_fixed_target(self, binding: super::UdpSessionFixedTarget) -> Self {
    ...
    pub fn with_rejected_response_identity(mut self, reason: UdpResponseDropReason) -> Self {
        self.identity = UdpResponseIdentityEvidence::Rejected(reason);
        self
    }

    pub fn validate_fixed_target(
        &self,
    ...
    pub fn fixed_target_expectation(
        &self,
        source: std::net::SocketAddr,
    ...
    pub fn take_fixed_target_payload(
        &mut self,
        expectation: UdpFixedTargetExpectation,
    ...
    pub fn append_execution_fields(
        &self,
    ...
    pub fn append_session_fields(&self, value: &mut serde_json::Value) {
