...
#[derive(Clone)]
pub struct ProxyUdpSessionCheckpoint {
...
impl ProxyUdpSessionCheckpoint {
    ...
    pub async fn hold_session(&self) {
        self.state
            .ready
    ...
    pub async fn wait_until_held(&self) -> Result<(), String> {
        loop {
...
pub async fn exercise_proxy_udp_packet_session(
