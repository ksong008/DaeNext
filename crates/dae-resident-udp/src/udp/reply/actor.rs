...
impl UdpReplyDispatcher {
    ...
    pub fn handle(&self) -> UdpReplyHandle {
        self.handle.clone()
    }

    pub async fn shutdown(mut self, deadline: time::Instant) -> Value {
