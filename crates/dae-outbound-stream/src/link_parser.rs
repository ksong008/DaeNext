...
use dae_outbound_core::anytls::AnyTLSLink;
...
use dae_outbound_core::shadowsocks::ShadowsocksLink;
use dae_outbound_core::trojan::TrojanLink;
use dae_outbound_core::tuic::TuicLink;
...
fn classify_link(scheme: &str, raw: &str) -> (&'static str, bool, &'static str) {
    match scheme {
        ...
        "ss" | "shadowsocks" => (shadowsocks_protocol(raw), true, "rust-native"),
        "socks" | "socks5" => ("socks5", true, "rust-native"),
        "http" | "https" => (scheme_to_protocol(scheme), true, "rust-native"),
        "trojan" | "trojan-go" => (trojan_protocol(raw), true, "rust-native"),
        "vmess" => ("vmess", true, "rust-native"),
        "vless" => ("vless", true, "rust-native"),
        "hysteria2" | "hy2" => ("hysteria2", true, "rust-native"),
        "tuic" => ("tuic", true, "rust-native"),
        "juicity" => ("juicity", true, "rust-native"),
        "anytls" => ("anytls", true, "rust-native"),
