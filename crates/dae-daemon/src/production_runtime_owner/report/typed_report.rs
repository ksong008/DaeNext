...
impl ProductionRuntimeTypedReport {
    ...
    pub(super) fn to_json(self) -> Value {
        json!({
            ...
            "production_daemon_admitted": self.production_dataplane_admitted && self.reload_runtime_parity_admitted,
            "production_admission_allowed": self.production_dataplane_admitted && self.reload_runtime_parity_admitted,
            ...
            "daemon_runtime_native_owner_production_admission_allowed": self.production_dataplane_admitted && self.reload_runtime_parity_admitted,
            ...
            "datapath_outbound_ebpf_deep_area_production_admission_allowed": self.production_dataplane_admitted && self.reload_runtime_parity_admitted,
        })
    }
}
