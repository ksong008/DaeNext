...
#[derive(Debug)]
pub(in crate::production_runtime_owner) struct ResidentDnsDomainRoutingMaintenanceHandle {
...
impl ResidentDnsDomainRoutingMaintenanceHandle {
    pub(in crate::production_runtime_owner) fn stop(&self) {
        self.signal.stop();
    }
}
...
impl ResidentDnsDomainRouting {
    pub(in crate::production_runtime_owner::resident_dataplane) fn start_maintenance(
        self: &Arc<Self>,
