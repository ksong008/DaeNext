...
pub(in crate::production_runtime_owner::resident_dataplane::dns) struct Socks5UdpRelay {
    address: SocketAddr,
...
impl Socks5UdpRelay {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane::dns) fn control_connections(
        &self,
    ) -> usize {
        self.control_connections.load(Ordering::Acquire)
    }

    pub(in crate::production_runtime_owner::resident_dataplane::dns) fn datagrams_forwarded(
        &self,
    ) -> usize {
...
#[derive(Clone, Copy)]
pub(in crate::production_runtime_owner::resident_dataplane::dns) enum DnsQuicTestProtocol {
    Doq,
    Doh3,
}
...
impl DnsQuicTestServer {
    pub(in crate::production_runtime_owner::resident_dataplane::dns) async fn start_with_response_delay(
        protocol: DnsQuicTestProtocol,
    ...
    pub(in crate::production_runtime_owner::resident_dataplane::dns) fn server_name(
        &self,
    ) -> &'static str {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane::dns) fn requests(&self) -> usize {
        self.requests.load(Ordering::Acquire)
    }

    pub(in crate::production_runtime_owner::resident_dataplane::dns) fn close_current(&self) {
...
pub(in crate::production_runtime_owner::resident_dataplane::dns) fn dns_test_response(
    bytes: usize,
    marker: u8,
) -> Vec<u8> {
...
pub(in crate::production_runtime_owner::resident_dataplane::dns) fn dns_a_test_response(
    query: &[u8],
    address: [u8; 4],
) -> Vec<u8> {
