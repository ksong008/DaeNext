...
impl ResidentDnsForwarderCache {
    pub(in crate::production_runtime_owner::resident_dataplane::dns) async fn acquire_health_proxy_udp_forwarder(
        self: &Arc<Self>,
        target: SocketAddr,
    ...
    pub(in crate::production_runtime_owner::resident_dataplane::dns) fn schedule_health_proxy_udp_forwarder_release(
        self: &Arc<Self>,
    ...
    pub(in crate::production_runtime_owner::resident_dataplane::dns) async fn release_health_proxy_udp_forwarder(
        self: Arc<Self>,
        key: ResidentDnsForwarderKey,
        forwarder: Arc<ResidentProxyDnsUdpForwarder>,
    ) -> Result<(), String> {
