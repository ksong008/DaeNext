...
pub(in crate::production_runtime_owner::resident_dataplane) enum ResidentProxyBindingScope {
    Configuration,
    Resident,
    ControlPlane,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::production_runtime_owner::resident_dataplane) enum ResidentSocketMarkPolicy {
    Configured,
    RouteOverride(u32),
    ControlFallback(u32),
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::production_runtime_owner::resident_dataplane) enum ResidentXhttpReusePolicy {
    Configured,
    NoPersistentReuse,
}

impl ResidentXhttpReusePolicy {
    pub(in crate::production_runtime_owner::resident_dataplane) const fn allows_persistent_reuse(
        self,
    ) -> bool {
...
impl ResidentProxyBinding {
    pub(in crate::production_runtime_owner::resident_dataplane) fn configuration(
        plan: Arc<ResidentProxyPlan>,
    ) -> Result<Self, String> {
        Self::new(
            plan,
    ...
    #[cfg(test)]
    pub(in crate::production_runtime_owner::resident_dataplane) fn resident(
        plan: Arc<ResidentProxyPlan>,
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn control_plane(
        plan: Arc<ResidentProxyPlan>,
    ) -> Result<Self, String> {
        Self::new(
            plan,
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn bind_resident_generation(
        &mut self,
        generation: OwnerGeneration,
    ) -> Result<(), String> {
        if generation.get() == 0 {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn bind_control_plane(&mut self) {
        self.execution = self
            .execution
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn with_route_socket_mark(
        mut self,
        mark: u32,
    ) -> Self {
    ...
    #[cfg(test)]
    pub(in crate::production_runtime_owner::resident_dataplane) fn with_control_socket_mark(
        mut self,
        mark: u32,
    ) -> Self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn apply_control_socket_mark(
        &mut self,
        mark: u32,
    ) {
        if mark != 0 {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn without_persistent_xhttp_reuse(
        mut self,
    ) -> Self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn chain_parent(
        &self,
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn plan(
        &self,
    ) -> &ResidentProxyPlan {
        &self.plan
    }

    pub(in crate::production_runtime_owner::resident_dataplane) fn shared_plan(
        &self,
    ) -> &Arc<ResidentProxyPlan> {
        &self.plan
    }

    pub(in crate::production_runtime_owner::resident_dataplane) fn into_shared_plan(
        self,
    ) -> Arc<ResidentProxyPlan> {
        self.plan
    }

    pub(in crate::production_runtime_owner::resident_dataplane) const fn execution(
        &self,
    ...
    #[cfg(test)]
    pub(in crate::production_runtime_owner::resident_dataplane) const fn scope(
        &self,
    ) -> ResidentProxyBindingScope {
        self.scope
    }
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn effective_socket_mark(
        &self,
    ) -> u32 {
    ...
    #[cfg(test)]
    pub(in crate::production_runtime_owner::resident_dataplane) const fn xhttp_reuse_policy(
        &self,
    ) -> ResidentXhttpReusePolicy {
        self.xhttp_reuse
    }

    pub(in crate::production_runtime_owner::resident_dataplane) fn persistent_xhttp_xmux(
        &self,
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn persistent_xhttp_download_xmux(
        &self,
    ) -> Option<&ResidentXhttpXmuxPlan> {
        self.xhttp_reuse
            .allows_persistent_reuse()
