...
pub(in crate::production_runtime_owner::resident_dataplane) enum ResidentUdpWireIdentityContract {
    DecodedSource,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::production_runtime_owner::resident_dataplane) struct ResidentUdpSourceContract {
...
impl ResidentUdpSourceContract {
    pub(in crate::production_runtime_owner::resident_dataplane) const fn fixed_target(
        wire_identity: ResidentUdpWireIdentityContract,
    ) -> Self {
        Self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) const fn direct() -> Self {
        Self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) const fn managed_dns() -> Self {
        Self::fixed_target(ResidentUdpWireIdentityContract::SessionBoundTarget)
    }

    pub(in crate::production_runtime_owner::resident_dataplane) const fn policy_closed() -> Self {
        Self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) const fn wire_identity(
        self,
    ) -> ResidentUdpWireIdentityContract {
        self.wire_identity
    }

    pub(in crate::production_runtime_owner::resident_dataplane) const fn multi_target_mode(
        self,
    ) -> &'static str {
        self.multi_target_mode
    }

    pub(in crate::production_runtime_owner::resident_dataplane) const fn compatibility_mode(
        self,
    ) -> &'static str {
