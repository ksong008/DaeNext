...
impl ResidentUdpChainAdmission {
    pub(in crate::production_runtime_owner::resident_dataplane) const fn status(
        self,
    ) -> &'static str {
        match self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) const fn carrier(
        self,
    ) -> &'static str {
        match self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) const fn unsupported_reason(
        self,
    ) -> Option<&'static str> {
        match self {
...
pub(in crate::production_runtime_owner::resident_dataplane) fn resident_udp_chain_admission(
    proxy: &ResidentProxyPlan,
) -> ResidentUdpChainAdmission {
