...
pub(in crate::production_runtime_owner::resident_dataplane) enum ResidentHealthTargetFamily {
...
impl ResidentHealthTargetResolver {
    ...
    #[cfg(test)]
    pub(in crate::production_runtime_owner::resident_dataplane) fn with_test_result(
        mut self,
        result: ResidentHealthTargetFamilies,
    ) -> Self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn identity(&self) -> String {
