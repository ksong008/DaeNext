...
pub(in crate::production_runtime_owner::resident_dataplane) struct TcpCandidateRacePolicy {
...
pub(in crate::production_runtime_owner::resident_dataplane) async fn try_tcp_socket_addr_candidates<
    T,
    F,
    Fut,
    E,
