...
#[derive(Debug)]
pub(in crate::production_runtime_owner::resident_dataplane) struct SocketAddressResolutionError {
    context: Box<str>,
    authority: Box<str>,
...
pub(in crate::production_runtime_owner::resident_dataplane) enum SocketCandidateAttemptError {
    Empty {
        context: Box<str>,
    },
    AllFailed {
...
#[derive(Debug, Eq, PartialEq)]
pub(in crate::production_runtime_owner::resident_dataplane) struct SocketCandidateFailure {
