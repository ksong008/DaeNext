...
use super::plan::{
    ...
    ResidentXhttpEndpointPlan, ResidentXhttpHttpVersion, ResidentXhttpMode, ResidentXhttpXmuxPlan,
};
use super::vision::{
...
use super::{
    ...
    XTLS_RPRX_VISION, resident_socket_addr_display, resident_tcp_network_name,
};
