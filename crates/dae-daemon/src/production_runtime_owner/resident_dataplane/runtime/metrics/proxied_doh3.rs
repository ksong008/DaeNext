...
pub(in crate::production_runtime_owner::resident_dataplane) struct ProxiedDoh3CleanupMetricObservation
{
...
impl ProxiedDoh3CleanupMetricObservation {
    pub(in crate::production_runtime_owner::resident_dataplane) const fn new(
        endpoint_forced_drop: bool,
        driver_aborted: bool,
        bridge_aborted: bool,
        failed: bool,
...
impl ResidentDataplaneMetrics {
    pub(in crate::production_runtime_owner::resident_dataplane) fn record_proxied_doh3_cleanup(
        &self,
    ...
    #[cfg(test)]
    pub(in crate::production_runtime_owner::resident_dataplane) fn proxied_doh3_cleanup_snapshot(
        &self,
    ) -> Value {
