...
pub(in crate::production_runtime_owner::resident_dataplane) fn materialized_source_shape(
...
pub(in crate::production_runtime_owner::resident_dataplane) fn source_shape_matches_materialization(
...
pub(in crate::production_runtime_owner::resident_dataplane) fn source_shape_classifies_materialization(
    row: &SourceShapeRegistryRow,
    proxy: &plan::ResidentProxyPlan,
    source_link: &str,
) -> bool {
...
#[cfg(test)]
pub(in crate::production_runtime_owner::resident_dataplane) fn materialized_source_runtime_ownership_model(
    proxy: &plan::ResidentProxyPlan,
) -> dae_outbound::RuntimeOwnershipModel {
    effective_materialized_runtime_ownership(proxy).model
}

pub(in crate::production_runtime_owner::resident_dataplane) fn source_shape_candidate_is_relevant(
    row: &SourceShapeRegistryRow,
