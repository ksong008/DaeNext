...
pub(crate) struct VisionInnerTlsState {
    pub(in crate::production_runtime_owner::resident_dataplane) client_pending: Vec<u8>,
    pub(in crate::production_runtime_owner::resident_dataplane) server_pending: Vec<u8>,
    pub(in crate::production_runtime_owner::resident_dataplane) decision: VisionTlsDecision,
    pub(in crate::production_runtime_owner::resident_dataplane) client_tls_observed: bool,
    pub(in crate::production_runtime_owner::resident_dataplane) client_tls13_advertised:
        Option<bool>,
}

impl VisionInnerTlsState {
    pub(in crate::production_runtime_owner::resident_dataplane) fn new() -> Self {
        Self {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn observe_client_payload(
        &mut self,
        payload: &[u8],
    ) -> Result<(), String> {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn observe_server_payload(
        &mut self,
        payload: &[u8],
    ) -> Result<(), String> {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn application_data_command(
        &self,
    ) -> Option<u8> {
        match self.decision {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn client_tls_filter_active(
        &self,
    ) -> bool {
