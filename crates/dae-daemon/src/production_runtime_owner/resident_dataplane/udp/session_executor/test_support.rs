...
#[derive(Clone)]
pub(in crate::production_runtime_owner::resident_dataplane) struct ProxyUdpSessionCheckpoint {
...
impl ProxyUdpSessionCheckpoint {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) async fn hold_session(&self) {
        self.state
            .ready
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) async fn wait_until_held(
        &self,
    ) -> Result<(), String> {
        loop {
    ...
    pub(in crate::production_runtime_owner::resident_dataplane) fn release_sessions(&self) {
        self.state
            .released
...
pub(in crate::production_runtime_owner::resident_dataplane) async fn exercise_proxy_udp_packet_session(
