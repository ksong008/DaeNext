...
#[cfg(test)]
pub(in crate::production_runtime_owner::resident_dataplane) struct AnyTlsUdpTestExchange {
    pub(in crate::production_runtime_owner::resident_dataplane) payload: Vec<u8>,
    pub(in crate::production_runtime_owner::resident_dataplane) sid: u32,
    pub(in crate::production_runtime_owner::resident_dataplane) physical_instance_id: u64,
    pub(in crate::production_runtime_owner::resident_dataplane) reused: bool,
}
