use super::protocol::{
    DecodedSubscriptionHelperOutcome, SUBSCRIPTION_HELPER_MAX_RESPONSE_BYTES,
    SubscriptionHelperRequest, decode_subscription_helper_response,
    encode_subscription_helper_request,
};
use super::*;
...
pub(in super::super) struct PreparedSubscriptionHelper {
    pub(in super::super) prepared: node_stage::PreparedSubscriptionRefresh,
    pub(in super::super) persist_staging: Option<PathBuf>,
}
...
pub(in super::super) enum SubscriptionHelperOutcome {
    Prepared(PreparedSubscriptionHelper),
    FetchFailed(fetch_error::SubscriptionFetchFailure),
}

pub(in super::super) fn prepare_subscription_with_helper(
    state: &Path,
    config_dir: &Path,
