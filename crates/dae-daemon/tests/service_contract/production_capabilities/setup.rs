...
pub(crate) fn production_service_contract_report() -> Value {
...
#[test]
pub(crate) fn production_reports_resident_service_and_dataplane_capabilities() {
    let report = production_service_contract_report();
    ...
    assert_live_release_and_runtime_state_contract(&report);
