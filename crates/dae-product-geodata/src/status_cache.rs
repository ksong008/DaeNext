...
#[derive(Clone, Debug)]
pub struct GeodataStatusCacheEntry {
...
impl GeodataStatusCacheEntry {
    ...
    pub fn new(identity: GeodataResourceIdentity, value: Value) -> Self {
        Self { identity, value }
    }

    pub fn matches(&self, identity: &GeodataResourceIdentity) -> bool {
