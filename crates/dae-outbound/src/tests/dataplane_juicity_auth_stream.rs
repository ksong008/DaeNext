...
#[test]
fn case_juicity_authenticate_header_matches_tuic_juicity_layout() {
...
#[test]
fn case_juicity_auth_stream_transcript_writes_header_before_dialauth_record() {
    let header = juicity::build_deterministic_authenticate_header();
    let dialauth =
    ...
    assert_eq!(transcript.target, "fixture-zero.fixture.invalid:0");
...
#[test]
fn case_juicity_auth_stream_smoke_admits_only_local_transcript_contract() {
    let report = juicity::auth_stream_smoke("fixture-zero.fixture.invalid:0").unwrap();

    assert_eq!(report.target, "fixture-zero.fixture.invalid:0");
