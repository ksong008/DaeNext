...
#[test]
fn case_ss2022_tcp_multi_psk_identity_header_roundtrips_payload() {
    let cipher = "2022-blake3-aes-128-gcm";
    let password = "AQIDBAUGBwgJCgsMDQ4PEA==:ERITFBUWFxgZGhscHR4fIA==";
    let target = "fixture-ss2022-multi-psk.fixture.invalid:8443";
    let payload = b"fixture-ss2022-multi-psk-ping".to_vec();
...
#[test]
fn case_ss2022_tcp_multi_psk_requires_multiple_psks() {
    let cipher = "2022-blake3-aes-128-gcm";
    ...
    let err = shadowsocks::encode_ss2022_tcp_multi_psk_client_initial(
        ...
        password,
        &[0x51; 16],
        "fixture-ss2022-multi-psk.fixture.invalid:8443",
        b"ping",
        1_765_000_089,
    )
    .unwrap_err();
