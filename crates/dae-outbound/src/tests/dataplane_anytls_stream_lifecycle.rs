...
#[test]
fn case_anytls_stream_lifecycle_frames_increment_sid_and_send_fin() {
    let first =
        anytls::stream_lifecycle_frames(1, "fixture-one.fixture.invalid:443", b"first").unwrap();
    let second =
        anytls::stream_lifecycle_frames(2, "fixture-two.fixture.invalid:443", b"second").unwrap();
...
#[test]
fn case_anytls_session_reuse_sequence_has_one_auth_and_two_streams() {
    let auth_handshake = anytls::link::handshake_auth_bytes("fixture-auth");
    let first =
        anytls::stream_lifecycle_frames(1, "fixture-one.fixture.invalid:443", b"first").unwrap();
    let second =
        anytls::stream_lifecycle_frames(2, "fixture-two.fixture.invalid:443", b"second").unwrap();
