...
#[test]
fn case_vless_grpc_http2_lifecycle_roundtrips_tcp_payload() {
    let key = vless::password_to_key("7c12c745-63a5-433d-9e60-022e469b5bd4").unwrap();
    let target = "fixture-vless-grpc-http2-target.fixture.invalid:443";
    let payload = b"fixture-vless-grpc-http2-ping".to_vec();
    let grpc = GrpcLifecycleOptions::new(
        "fixture-vless-grpc-http2-proxy.fixture.invalid:443",
        "",
        "fixture-vless-grpc-http2-sni.fixture.invalid",
        "fixture-vless-dialer",
        true,
        1340,
        true,
    );
    ...
    assert!(
        report
            .grpc_cache_key
            .contains("fixture-vless-grpc-http2-proxy.fixture.invalid:443")
    );
    assert!(
        report
            .grpc_cache_key
            .contains("fixture-vless-grpc-http2-sni.fixture.invalid")
    );
}

#[test]
fn case_vmess_grpc_http2_lifecycle_roundtrips_aead_tcp_payload() {
    let uuid = "7c12c745-63a5-433d-9e60-022e469b5bd4";
    let target = "fixture-vmess-grpc-http2-target.fixture.invalid:443";
    let payload = b"fixture-vmess-grpc-http2-ping".to_vec();
    let grpc = GrpcLifecycleOptions::new(
        "fixture-vmess-grpc-http2-proxy.fixture.invalid:443",
        "dae-fixture-grpc",
        "fixture-vmess-grpc-http2-sni.fixture.invalid",
        "fixture-vmess-dialer",
        true,
        1341,
        true,
    );
    ...
    assert_eq!(report.target, target);
    assert_eq!(report.echoed_payload, payload);
    assert_eq!(report.grpc_service_name, "dae-fixture-grpc");
    assert_eq!(report.command, vmess::VMessNetwork::Tcp.byte());
    ...
    assert!(
        report
            .grpc_cache_key
            .contains("fixture-vmess-grpc-http2-proxy.fixture.invalid:443")
    );
    assert!(
        report
            .grpc_cache_key
            .contains("fixture-vmess-grpc-http2-sni.fixture.invalid")
    );
}
