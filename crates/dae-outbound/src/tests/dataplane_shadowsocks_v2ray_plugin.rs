...
#[test]
fn case_sip003_v2ray_plugin_wraps_tls_ws_mux_shadowsocks_aead_tcp() {
    let cipher = "aes-128-gcm";
    let password = "fixture-password";
    let proxy = "127.0.0.1:0";
    let target = "fixture-sip003-v2ray-plugin.fixture.invalid:8443";
    let payload = b"fixture-sip003-v2ray-plugin-ping".to_vec();
    ...
    let options = shadowsocks::Sip003V2rayPluginOptions::new(
        "fixture-v2ray-plugin.fixture.invalid",
        "http/1.1",
        "fixture-v2ray-host.fixture.invalid",
        "/",
    )
    .unwrap();
    ...
    let handle = thread::spawn(move || {
        ...
        assert!(request_text.contains("Host: fixture-v2ray-host.fixture.invalid\r\n"));
        tls.write_all(
            format!(
    ...
    assert_eq!(
        report.tls_server_name,
        "fixture-v2ray-plugin.fixture.invalid"
    );
    assert_eq!(report.selected_alpn, "http/1.1");
    assert_eq!(report.ws_host, "fixture-v2ray-host.fixture.invalid");
...
#[test]
fn case_sip003_v2ray_plugin_options_keep_native_mux_defaults() {
    let options = shadowsocks::Sip003V2rayPluginOptions::new(
        "sni.fixture.invalid",
        "http/1.1",
