...
#[test]
fn case_synthetic_utls_clienthello_builder_roundtrips_fixture_profiles() {
...
#[test]
fn case_synthetic_utls_clienthello_builder_rejects_profiles_without_padding_room() {
    let fixture = fixture("outbound/protocol/utls_clienthello_profile.json");
