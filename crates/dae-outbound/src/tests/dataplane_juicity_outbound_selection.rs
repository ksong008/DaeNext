...
#[test]
fn case_juicity_outbound_dataplane_selects_alive_group_and_runs_client_smoke() {
    let outcome =
    ...
    assert_eq!(
        ...
        vec!["slow.fixture.invalid:443", "fast.fixture.invalid:8443"]
    );
    assert_eq!(outcome.selected_index, 1);
    assert_eq!(outcome.selected_name, "juicity-fast");
    assert_eq!(outcome.selected_address, "fast.fixture.invalid:8443");
    ...
    assert_eq!(outcome.selected_chain_adapter_mode, "rust-native");
