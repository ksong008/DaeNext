...
#[test]
fn socks5_rust_native_matches_nativelden_fixture() {
    let fixture = fixture("outbound/protocol/socks5_rust_native.json");
    ...
    assert_eq!(parsed.nodes[0].adapter_mode, "rust-native");
    assert_eq!(
    ...
    assert_eq!(
        hex_encode(&crate::socks5::handshake::connect_request("fixture.invalid:443").unwrap()),
        handshake["connect_fixture_invalid_443_hex"]
            .as_str()
            .unwrap()
    );
    assert_eq!(
...
#[test]
fn http_rust_native_matches_nativelden_fixture() {
    let fixture = fixture("outbound/protocol/http_rust_native.json");
    ...
    for case in fixture["link_parser"].as_array().unwrap() {
        ...
        assert_eq!(parsed_chain.nodes[0].adapter_mode, "rust-native");
    }
