...
#[test]
fn case_juicity_live_ekm_auth_token_matches_across_quic_connection() {
    ...
    assert_eq!(report.target, "juicity-ekm-auth.fixture.invalid:0");
    ...
    assert_eq!(report.dialauth_record_len, 100);
    assert_eq!(report.transcript_len, 150);
