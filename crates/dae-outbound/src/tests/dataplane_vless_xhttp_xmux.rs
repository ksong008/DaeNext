...
fn case_vless_xhttp_xmux_dataplane_echoes_payload() {
    ...
    assert_eq!(report.xhttp_path, "/dae-fixture-xhttp-xmux/");
    assert_eq!(
        report.xhttp_request_path,
        "/dae-fixture-xhttp-xmux/?session=dae-fixture-xhttp-xmux&seq=80"
    );
