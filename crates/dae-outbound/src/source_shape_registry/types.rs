...
pub struct ScopedExpandedSourceMatrixEvidence {
    ...
    pub cleanup_artifact: &'static str,
    pub row_count: u64,
    pub pass_count: u64,
    pub all_pass: bool,
...
impl ScopedExpandedSourceMatrixEvidence {
    pub fn to_value(self) -> Value {
        json!({
            ...
            "cleanupArtifact": self.cleanup_artifact,
...
pub struct SourceShapeRegistryRow {
    ...
    pub runtime_ownership: RuntimeOwnershipProfile,
...
impl SourceShapeRegistryRow {
    pub fn to_value(self) -> Value {
        json!({
            ...
            "runtimeOwnershipLedger": self.runtime_ownership_ledger(),
...
pub struct ProductionReadinessReconciliation {
    ...
    pub product_switch_ready: bool,
    pub final_state_ready: bool,
    pub cleanup_evidence_ready: bool,
}
...
impl ProductionReadinessReconciliation {
    pub fn to_value(self) -> Value {
        json!({
            ...
            "productSwitchReady": self.product_switch_ready,
            "finalStateReady": self.final_state_ready,
            "cleanupEvidenceReady": self.cleanup_evidence_ready,
        })
    }
}
