use super::*;
pub const DEFAULT_STREAM_PACKET_CONGESTION_TARGET: &str = "juicity-congestion.fixture.invalid:5353";
pub const DEFAULT_STREAM_PACKET_CONGESTION_RESPONSE_TARGET: &str =
    "juicity-congestion-response.fixture.invalid:5353";
...
pub const JUICITY_CONGESTION_DEFAULT: &str = "bbr";
pub const JUICITY_CONGESTION_CWND_PARAM: usize = 10;
pub const BBR_INITIAL_CONGESTION_WINDOW_PACKETS: usize = 32;
pub const BBR_INITIAL_PACKET_SIZE_IPV4: usize = 1280;
pub const RUST_BBR_INITIAL_WINDOW_BYTES: u64 =
    (BBR_INITIAL_CONGESTION_WINDOW_PACKETS * BBR_INITIAL_PACKET_SIZE_IPV4) as u64;
...
pub struct JuicityStreamPacketCongestionReport {
    ...
    pub congestion_control_default: String,
    pub cwnd_param: usize,
    pub bbr_initial_congestion_window_packets: usize,
    pub bbr_initial_packet_size_ipv4: usize,
