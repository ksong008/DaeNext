...
pub use source_shape_registry::{
    ...
    GENERATION_OWNED_MEEK_OWNERSHIP, GENERATION_OWNED_TUIC_OWNERSHIP, LogicalLeaseKind,
    MATERIALIZED_CHAIN_OWNERSHIP, MATERIALIZED_SHAPE_REJECTED_OWNERSHIP,
    MATERIALIZED_STREAM_SECURITY_OWNERSHIP, MaterializedChain, MaterializedChainUdp,
    MaterializedExecutionShape, MaterializedPassthroughUdp, MaterializedPolicyClosedReason,
    MaterializedPortHopping, MaterializedProtocol, MaterializedQuicVerification,
    MaterializedSecurity, MaterializedSourceImport, MaterializedSourceShape,
    MaterializedStreamPacketTransport, MaterializedTlsFeatures, MaterializedTlsVariant,
    MaterializedUdp, MaterializedWrapper, MaterializedXhttpMode, MaterializedXhttpSettings,
    PacketSemantics, PhysicalCarrierKind, PhysicalOwnerKeyContract,
    ProductionReadinessReconciliation, ProtocolFraming, QUIC_FAMILY_MATERIALIZED_OWNERSHIP,
    ...
    ShapeStateLedger, SourceShapeReconciliation, SourceShapeReconciliationKind,
    SourceShapeRegistryContract, SourceShapeRegistryRow, SourceShapeSelector, SourceShapeState,
    ...
    source_shape_reconciliation, source_shape_reconciliations, source_shape_registry_contract,
