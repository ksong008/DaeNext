...
pub async fn handle_direct_tcp_connection_async(
...
#[allow(clippy::too_many_arguments)]
pub fn direct_tcp_finished_event(
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: &TcpDirectSelection,
...
pub fn append_tcp_route_log_fields(
    event: &mut Value,
...
pub async fn sniff_initial_tcp_payload_async(
    inbound: &mut TokioTcpStream,
    timeout: Duration,
...
pub fn sniff_needs_more(err: &SniffingError) -> bool {
