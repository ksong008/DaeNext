use super::*;
use crate::acquire_vless_mux_logical_stream;
use std::borrow::Cow;
pub async fn handle_proxy_tcp_connection_async(
...
pub async fn handle_vless_plain_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vless_mux_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vless_websocket_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vless_httpupgrade_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vless_meek_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
