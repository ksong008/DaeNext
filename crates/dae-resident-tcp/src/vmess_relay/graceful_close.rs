use super::*;
pub fn is_graceful_shadowsocks_response_message(message: &str) -> bool {
...
pub fn is_graceful_vmess_response_message(message: &str) -> bool {
    message.contains("early eof")
        || message.contains("failed to fill whole buffer")
        || message.contains("Connection reset")
        || message.contains("connection reset")
...
pub fn is_graceful_stream_close_error(err: &std::io::Error) -> bool {
    matches!(
        err.kind(),
...
pub fn is_graceful_stream_close_message(message: &str) -> bool {
    message.contains("Broken pipe")
        || message.contains("Connection reset")
...
pub fn is_graceful_tls_plain_close_error(err: &std::io::Error) -> bool {
