...
pub struct RelayStats {
    pub client_to_proxy: usize,
    pub proxy_to_client: usize,
    pub response_header_stripped: bool,
    pub vision_unpadding_blocks: usize,
    pub vision_direct_command_seen: bool,
    pub vision_raw_direct_recovered: bool,
    pub vision_downlink_direct_active: bool,
}
...
impl RelayError {
    pub fn new(message: impl Into<String>, stats: &RelayStats) -> Self {
        Self {
...
pub fn is_graceful_vless_response_tls_plain_close_error(
    err: &std::io::Error,
    stats: &RelayStats,
) -> bool {
...
impl VlessResponseStripper {
    pub fn consume<'a>(&mut self, input: &'a [u8]) -> Result<std::borrow::Cow<'a, [u8]>, String> {
        if self.done {
