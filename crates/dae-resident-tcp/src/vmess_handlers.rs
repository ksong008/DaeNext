...
pub async fn handle_vmess_proxy_tcp_connection_async(
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vmess_tls_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vmess_websocket_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vmess_httpupgrade_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vmess_websocket_tls_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vmess_httpupgrade_tls_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vmess_grpc_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_vmess_h2_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
