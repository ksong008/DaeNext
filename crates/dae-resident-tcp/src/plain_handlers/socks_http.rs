...
pub async fn handle_socks5_proxy_tcp_connection_async(
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_http_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
...
#[allow(clippy::too_many_arguments)]
pub async fn handle_https_proxy_tcp_connection_async(
    inbound: &mut TokioTcpStream,
    peer: SocketAddr,
    original_dst: SocketAddr,
    selection: TcpProxySelection,
    ...
    dae_outbound_core::http_proxy::application_protocol::EffectiveHttpProxyApplicationProtocol::Http1
...
pub async fn http_proxy_connect_async(
