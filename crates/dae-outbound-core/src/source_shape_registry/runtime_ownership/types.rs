...
pub enum RuntimeOwnershipModel {
    ...
    GenerationOwnedAnyTlsTransport,
    GenerationOwnedH2Transport,
    GenerationOwnedMeekTransport,
    GenerationOwnedVlessMuxTransport,
    GenerationOwnedXhttpTransport,
...
impl RuntimeOwnershipModel {
    pub fn as_report_str(self) -> &'static str {
        match self {
            ...
            Self::GenerationOwnedAnyTlsTransport => "generation-owned-anytls-transport",
            Self::GenerationOwnedH2Transport => "generation-owned-h2-transport",
            ...
            Self::GenerationOwnedXhttpTransport => "generation-owned-xhttp-transport",
...
impl PhysicalCarrierKind {
    pub(super) fn as_report_str(self) -> &'static str {
        match self {
            ...
            Self::ReusableFrameStreamConnection => "reusable-frame-stream-connection",
...
impl LogicalLeaseKind {
    pub(super) fn as_report_str(self) -> &'static str {
        match self {
            ...
            Self::FramedByteStream => "framed-byte-stream",
            Self::Http2Stream => "http2-stream",
