...
const sudoPreserveEnv = "TERM,LANG,LC_ALL,LC_CTYPE"
...
func trySudo() (path string, arg []string) {
	...
	return pathSudo, buildSudoArgs(pathSudo)
}

func buildSudoArgs(pathSudo string) []string {
	return []string{
		pathSudo,
		"--preserve-env=" + sudoPreserveEnv,
		"-p",
