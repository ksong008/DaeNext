...
var GlobalDesc = Desc{
	...
	"udp_endpoint_pool_size": "Maximum number of cached UDP endpoints before dae evicts the oldest inactive entries. Increase it for heavy QUIC, gaming, or P2P workloads.",
