...
pub struct TraceEventAbiContract {
    ...
    pub events_c_default_bytes: u32,
    pub events_go_default_bytes: u32,
...
pub struct TraceCoreSideloadGateReport {
    ...
    pub enabled: bool,
    pub go_trace_adoption_ready: bool,
    pub default_daemon_path: bool,
...
pub fn trace_kprobe_program_specs() -> Vec<TraceKprobeProgramSpec> {
    vec![
        ...
        TraceKprobeProgramSpec {
            c_section: "kprobe/skb_lifetime_termination",
...
pub fn trace_kprobe_evidence_queue() -> Vec<KernelProgramParityEvidenceLine> {
    vec![
        trace_evidence_line(
            ...
            "trace/kern/trace.c + trace/tracker.go",
        ),
        trace_evidence_line(
            "tracing_cfg_rewrite_contract",
            KernelProgramParityEvidenceStatus::Passed,
            "trace/trace.go:rewriteAndLoadBpfViaGo + dae-ebpf-support::AyaTraceConfig",
        ),
        trace_evidence_line(
        ...
        trace_evidence_line(
            ...
            KernelProgramParityEvidenceStatus::Passed,
            "trace/trace.go:searchAvailableTargets",
        ),
        trace_evidence_line(
            "rust_skb_core_read_semantics",
            KernelProgramParityEvidenceStatus::Missing,
            "trace/kern/trace.c:get_netns/filter_l3_and_l4/set_meta/set_tuple",
        ),
        trace_evidence_line(
            "rust_trace_load_pin_smoke",
            KernelProgramParityEvidenceStatus::Passed,
            "DAEX_RUST_PERFORMANCE_OPTIMIZATION_PLAN_2026-05-24.md:trace load-pin smoke 2026-05-30; CO-RE side-load remains disabled",
        ),
        trace_evidence_line(
            "rust_trace_attach_and_ringbuf_smoke",
            KernelProgramParityEvidenceStatus::Passed,
            "DAEX_RUST_PERFORMANCE_OPTIMIZATION_PLAN_2026-05-24.md:trace attach-ringbuf smoke 2026-05-30; CO-RE side-load remains disabled",
        ),
    ]
}
