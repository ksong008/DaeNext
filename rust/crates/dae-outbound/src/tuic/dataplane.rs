...
pub fn run_true_quic_dataplane_smoke(
    ...
    let native_contract_admitted = chain.property_protocol == "tuic"
        && node.adapter_mode == "native-opt-in"
    ...
    let udp_relay_mode_go_parity_caveat_recorded = link.udp_relay_mode == "quic";
    ...
    let true_quic_dataplane_admitted = native_contract_admitted
        ...
        && udp_relay_mode_go_parity_caveat_recorded
    ...
    Ok(TuicTrueQuicDataplaneReport {
        ...
        tuic_native_optin_contract_admitted: native_contract_admitted,
        ...
        tuic_udp_relay_mode_go_parity_caveat_recorded: udp_relay_mode_go_parity_caveat_recorded,
