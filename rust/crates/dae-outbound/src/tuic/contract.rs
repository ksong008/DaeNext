...
pub const UDP_RELAY_MODE_GO_PROTOCOL_EFFECTIVE_MODE: &str = "native";
pub const UDP_RELAY_MODE_GO_COMMON_QUIC_NUMERIC_VALUE: u8 = 0;
pub const UDP_RELAY_MODE_GO_COMMON_NATIVE_VALUE: u8 = 1;
