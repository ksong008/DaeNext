...
#[test]
fn stage93_sip003_simple_obfs_tls_wraps_shadowsocks_aead_tcp() {
    let cipher = "aes-128-gcm";
    let password = "stage93-password";
    let target = "stage93-sip003-simple-obfs-tls.example:8443";
    let payload = b"stage93-sip003-simple-obfs-tls-ping".to_vec();
    let client_salt = hex_decode("303132333435363738393a3b3c3d3e3f");
    let server_salt = hex_decode("707172737475767778797a7b7c7d7e7f");
    let options = shadowsocks::Sip003SimpleObfsTlsOptions::new("tls-front.example");
    ...
    assert_eq!(report.server_name, "tls-front.example");
...
#[test]
fn stage93_sip003_simple_obfs_tls_options_keep_go_default_host() {
