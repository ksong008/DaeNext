...
#[test]
fn stage131_tuic_true_quic_dataplane_smoke_admits_tuic_only() {
    ...
    assert!(outcome.tuic_native_optin_contract_admitted);
    ...
    assert!(outcome.tuic_udp_relay_mode_go_parity_caveat_recorded);
