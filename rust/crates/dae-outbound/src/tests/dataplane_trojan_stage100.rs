...
#[test]
fn stage100_tls_fragment_splits_and_reassembles_handshake_record() {
...
#[test]
fn stage100_tls_fragment_preserves_passthrough_boundaries() {
...
#[test]
fn stage100_tls_fragment_range_parser_matches_go_error_boundary() {
    assert_eq!(
