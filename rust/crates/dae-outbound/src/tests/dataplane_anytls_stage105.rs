...
#[test]
fn stage105_anytls_udp_packet_first_write_matches_go_packet_stream() {
    let target = "stage105-udp.example:5353";
    let payload = b"stage105-first-packet";
...
#[test]
fn stage105_anytls_udp_packet_next_write_carries_only_length_and_payload() {
    let payload = b"stage105-next-packet";
...
#[test]
fn stage105_anytls_udp_packet_stream_uses_magic_domain_and_tcp_underlay() {
    let original_target = "stage105-udp.example:5353";
    ...
    let first_write = anytls::link::packet_first_write(original_target, b"stage105-first").unwrap();
    let next_write = anytls::link::packet_next_write(b"stage105-next");
