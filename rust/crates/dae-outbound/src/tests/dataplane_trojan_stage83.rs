...
#[test]
fn stage83_trojan_tls_tcp_dataplane_echoes_payload() {
    ...
    let password = "stage83-password";
    let target = "stage83-trojan.example:443";
    let payload = b"stage83-trojan-tls-ping".to_vec();
