...
#[test]
fn stage127_juicity_stream_packet_congestion_runs_sustained_bbr_relay() {
    ...
    assert_eq!(outcome.go_congestion_control_default, "bbr");
    assert_eq!(outcome.go_cwnd_param, 10);
    assert_eq!(outcome.go_bbr_initial_congestion_window_packets, 32);
    assert_eq!(outcome.go_bbr_initial_packet_size_ipv4, 1280);
