...
const STREAM_WRAPPER_CAPABILITY_ROWS: [StreamWrapperCapabilityRow; 5] = [
    StreamWrapperCapabilityRow {
        ...
        status: "resident-live-partial",
        source_admission: "blocked-until-multi-handler-benchmark-rollback",
        ...
        blocker_id: Some("incomplete-wrapper-coverage"),
        evidence_requirements: &[
            "multi-handler-resident-materialization",
            "benchmark",
            "rollback",
        ],
    },
