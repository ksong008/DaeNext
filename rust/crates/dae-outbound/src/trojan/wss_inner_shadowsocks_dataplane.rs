...
pub struct TrojanGoWssInnerShadowsocksTcpExchangeReport {
    ...
    pub trojan_go_wss_inner_shadowsocks: bool,
    ...
    S: Read + Write,
{
    ...
    let request_frame = trojan_go_wss_inner_shadowsocks_request_frame(
        cipher,
    ...
    Ok(TrojanGoWssInnerShadowsocksTcpExchangeReport {
        ...
        trojan_go_wss_inner_shadowsocks: true,
        true_dataplane: true,
        default_go_path: true,
    })
}

pub fn trojan_go_wss_inner_shadowsocks_request_frame(
    cipher: &str,
    shadowsocks_password: &str,
    trojan_password: &str,
    target: &str,
...
pub fn trojan_go_wss_inner_shadowsocks_response_frame(
    cipher: &str,
    shadowsocks_password: &str,
    salt: &[u8],
    _response_metadata_target: &str,
