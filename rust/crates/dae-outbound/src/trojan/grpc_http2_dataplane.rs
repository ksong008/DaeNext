...
pub struct TrojanGoGrpcHttp2TlsExchangeReport {
    pub proxy: String,
    pub target: String,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct TrojanGoGrpcHttp2Request {
...
pub fn tcp_exchange_over_grpc_http2_stream<S>(
    ...
    payload: &[u8],
) -> Result<TrojanGoGrpcHttp2TlsExchangeReport, OutboundError>
where
    S: Read + Write,
{
    ...
    Ok(TrojanGoGrpcHttp2TlsExchangeReport {
...
pub fn read_tcp_request_from_grpc_http2_stream<S>(
    ...
    payload_len: usize,
) -> Result<TrojanGoGrpcHttp2Request, OutboundError>
where
    S: Read,
{
