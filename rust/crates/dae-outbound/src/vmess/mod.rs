...
pub use dataplane::{
    ...
    aead_tcp_exchange_over_grpc_hunk_stream, aead_tcp_exchange_over_httpupgrade_stream,
    ...
    read_aead_packet_addr_udp_request_from_stream, read_aead_tcp_request_from_grpc_hunk_stream,
