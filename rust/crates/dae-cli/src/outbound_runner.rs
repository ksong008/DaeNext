...
fn run_transport(args: &[String]) -> RunnerOutput {
    match args.first().map(String::as_str) {
...
fn run_transport_contract() -> RunnerOutput {
    RunnerOutput::ok(format!(
        "{}\n",
        json!({
...
fn run_transport_xhttp_mode(args: &[String]) -> RunnerOutput {
...
fn run_transport_xhttp_alpn(args: &[String]) -> RunnerOutput {
    let security = string_arg(args, "--security").unwrap_or("tls");
...
fn run_transport_xhttp_path(args: &[String]) -> RunnerOutput {
...
fn run_transport_xhttp_extra(args: &[String]) -> RunnerOutput {
...
fn run_transport_grpc_cache_key(args: &[String]) -> RunnerOutput {
...
fn run_transport_reality(args: &[String]) -> RunnerOutput {
...
fn run_transport_smoke() -> RunnerOutput {
