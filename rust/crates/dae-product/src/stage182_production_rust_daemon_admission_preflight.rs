...
pub struct Stage182ProductionRustDaemonAdmissionPreflightContract {
    pub name: &'static str,
    pub stage: &'static str,
    pub prior_gate: &'static str,
    pub stage_complete: bool,
    pub production_rust_daemon_admission_preflight_recorded: bool,
    pub stage181_runtime_blocker_carried: bool,
    pub command_identity_checked: bool,
    pub config_corpus_binding_checked: bool,
    pub progress_pid_signal_lifecycle_checked: bool,
    pub startup_reload_control_plane_requirements_checked: bool,
    pub default_path_isolation_checked: bool,
    pub benchmark_exclusion_checked: bool,
    pub stage156_optin_identity_carried: bool,
    pub stage157_control_plane_evidence_required: bool,
    pub stage178_reviewed_artifact_required: bool,
    pub stage179_verifier_required: bool,
    ...
    pub rust_production_run_command_admitted: bool,
    ...
    pub rows: Vec<Stage182ProductionRustDaemonAdmissionPreflightRow>,
    pub admission_requirements: Vec<&'static str>,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Stage182ProductionRustDaemonAdmissionPreflightRow {
    pub area: &'static str,
    pub status: &'static str,
    pub current_evidence: &'static str,
    pub required_before_admission: &'static str,
    pub boundary: &'static str,
    pub closed_flag: &'static str,
}

pub fn stage182_production_rust_daemon_admission_preflight_contract()
-> Stage182ProductionRustDaemonAdmissionPreflightContract {
    Stage182ProductionRustDaemonAdmissionPreflightContract {
        ...
        stage_complete: true,
        production_rust_daemon_admission_preflight_recorded: true,
        stage181_runtime_blocker_carried: true,
        command_identity_checked: true,
        config_corpus_binding_checked: true,
        progress_pid_signal_lifecycle_checked: true,
        startup_reload_control_plane_requirements_checked: true,
        default_path_isolation_checked: true,
        benchmark_exclusion_checked: true,
        stage156_optin_identity_carried: true,
        stage157_control_plane_evidence_required: true,
        stage178_reviewed_artifact_required: true,
        stage179_verifier_required: true,
        go_default_path_preserved: true,
        go_fallback_required: true,
        reviewed_real_corpus_ready: false,
        rust_production_dae_run_command_exists: false,
        rust_production_run_command_admitted: false,
        ...
        gate_decision: "stage182 records one merged production Rust daemon admission preflight covering command identity, reviewed corpus binding, lifecycle, runtime evidence, default isolation, and benchmark exclusion without admitting a production Rust dae run or switching default/product paths",
        rows: vec![
