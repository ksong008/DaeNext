...
pub struct Stage110Hysteria2FullQuicQueueGateContract {
    pub name: &'static str,
    ...
    pub rows: Vec<Stage110Hysteria2FullQuicQueueGateRow>,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Stage110Hysteria2FullQuicQueueGateRow {
    pub area: &'static str,
...
pub fn stage110_hysteria2_full_quic_queue_gate_contract()
-> Stage110Hysteria2FullQuicQueueGateContract {
    Stage110Hysteria2FullQuicQueueGateContract {
        name: "stage110-hysteria2-full-quic-client-blocker-queue-gate",
        stage: "stage110",
        prior_gate: "stage109-hysteria2-udp-underlay-gate",
        stage_complete: true,
        ...
        gate_decision: "stage110 carries Stage109 Hysteria2 UDP underlay admission but keeps the full Hysteria2 QUIC client blocked: real QUIC handshake, stream mux, packet/datagram target relay, and port hopping scheduler are still missing, so quic_h3_family/outbound/default/product switches remain closed",
        rows: vec![
            Stage110Hysteria2FullQuicQueueGateRow {
                ...
                next_action: "carry underlay as a prerequisite only",
            },
            Stage110Hysteria2FullQuicQueueGateRow {
                ...
                next_action: "build true QUIC loopback handshake before opening this row",
            },
            Stage110Hysteria2FullQuicQueueGateRow {
                ...
                next_action: "add Hysteria2 TCP stream and UDP packet relay gates after handshake exists",
            },
            Stage110Hysteria2FullQuicQueueGateRow {
                ...
                next_action: "add scheduler gate tied to UDPHopInterval after QUIC underlay exists",
            },
            Stage110Hysteria2FullQuicQueueGateRow {
        ...
        benchmark_carry_forward: vec![
            ...
            "Stage 110 records no new network benchmark because it is a read-only full QUIC client blocker queue",
        ],
