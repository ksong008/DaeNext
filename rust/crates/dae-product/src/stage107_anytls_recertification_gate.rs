...
pub struct Stage107AnyTlsRecertificationGateContract {
    pub name: &'static str,
    ...
    pub rows: Vec<Stage107AnyTlsRecertificationGateRow>,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Stage107AnyTlsRecertificationGateRow {
    pub area: &'static str,
...
pub fn stage107_anytls_recertification_gate_contract() -> Stage107AnyTlsRecertificationGateContract
{
    Stage107AnyTlsRecertificationGateContract {
        name: "stage107-anytls-protocol-wide-recertification-gate",
        stage: "stage107",
        prior_gate: "stage106-anytls-idle-session-reuse-gate",
        stage_complete: true,
        ...
        gate_decision: "stage107 recertifies AnyTLS protocol-wide opt-in after Stage104 session/frame, Stage105 UDP packet stream, and Stage106 idle-session reuse/lifecycle all passed true dataplane gates; anytls_true_dataplane_admitted=true is now allowed, while QUIC/H3 family protocols, outbound default, matched default-daemon benchmark, and product-chain switches remain closed",
        rows: vec![
            Stage107AnyTlsRecertificationGateRow {
                ...
                next_action: "carry as a required predicate for protocol-wide AnyTLS admission",
            },
            Stage107AnyTlsRecertificationGateRow {
            ...
            Stage107AnyTlsRecertificationGateRow {
                ...
                next_action: "carry as the final required predicate for protocol-wide AnyTLS admission",
            },
            Stage107AnyTlsRecertificationGateRow {
                ...
                next_action: "carry AnyTLS into the next broader protocol matrix without opening defaults",
            },
            Stage107AnyTlsRecertificationGateRow {
                ...
                next_action: "continue remaining protocol family gates before reopening defaults",
            },
        ],
        benchmark_carry_forward: vec![
            ...
            "Stage 107 records no new network benchmark because it is a read-only recertification gate",
        ],
        ...
        source: vec![
            ...
            "rust/crates/dae-cli/src/runtime_stage107_anytls_recertification_gate.rs",
        ],
    }
}
