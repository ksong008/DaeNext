...
#[test]
fn stage137_vless_vmess_xhttp_h3_gate_matches_golden_fixture() {
    let fixture = load("product/daemon/stage137_vless_vmess_xhttp_h3_lifecycle_gate.json");
    let contract = stage137_vless_vmess_xhttp_h3_gate_contract();
...
#[test]
fn stage137_vless_vmess_xhttp_h3_admits_only_subrows() {
    let contract = stage137_vless_vmess_xhttp_h3_gate_contract();
    ...
    assert!(contract.vless_xhttp_http2_lifecycle_admitted);
    assert!(contract.vmess_xhttp_http2_lifecycle_admitted);
    assert!(contract.vless_xhttp_h3_lifecycle_admitted);
    assert!(contract.vmess_xhttp_h3_lifecycle_admitted);
    assert!(contract.vless_xhttp_h2_h3_lifecycle_admitted);
    assert!(contract.vmess_xhttp_h2_h3_lifecycle_admitted);
