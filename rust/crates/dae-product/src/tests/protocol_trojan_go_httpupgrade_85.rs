...
#[test]
fn stage85_trojan_go_httpupgrade_gate_matches_golden_fixture() {
    let fixture = load("product/daemon/stage85_trojan_go_httpupgrade_dataplane_gate.json");
    let contract = stage85_trojan_go_httpupgrade_gate_contract();
...
#[test]
fn stage85_trojan_go_httpupgrade_gate_keeps_full_trojan_go_and_defaults_closed() {
    let contract = stage85_trojan_go_httpupgrade_gate_contract();
