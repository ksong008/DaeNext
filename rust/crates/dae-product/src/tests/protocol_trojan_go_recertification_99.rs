...
#[test]
fn stage99_trojan_go_recertification_gate_matches_golden_fixture() {
    let fixture =
        load("product/daemon/stage99_trojan_go_shared_transport_recertification_gate.json");
    let contract = stage99_trojan_go_recertification_gate_contract();
...
#[test]
fn stage99_trojan_go_recertification_keeps_full_transport_and_defaults_closed() {
    let contract = stage99_trojan_go_recertification_gate_contract();
