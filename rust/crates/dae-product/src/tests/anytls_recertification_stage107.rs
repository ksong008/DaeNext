...
#[test]
fn stage107_anytls_recertification_gate_matches_golden_fixture() {
    let fixture = load("product/daemon/stage107_anytls_protocol_wide_recertification_gate.json");
    let contract = stage107_anytls_recertification_gate_contract();
...
#[test]
fn stage107_anytls_recertification_keeps_defaults_closed() {
    let contract = stage107_anytls_recertification_gate_contract();
    ...
    assert_contains_text(&contract.remaining_blockers, "matched Go default daemon");
}
