...
#[test]
fn stage138_vless_vmess_residual_gate_matches_golden_fixture() {
    let fixture = load("product/daemon/stage138_vless_vmess_utls_reality_vision_blocker_gate.json");
    let contract = stage138_vless_vmess_residual_gate_contract();
...
#[test]
fn stage138_vless_vmess_residual_gate_keeps_protocol_wide_closed() {
    let contract = stage138_vless_vmess_residual_gate_contract();
