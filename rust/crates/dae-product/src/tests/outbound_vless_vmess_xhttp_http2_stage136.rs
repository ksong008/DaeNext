...
#[test]
fn stage136_vless_vmess_xhttp_http2_gate_matches_golden_fixture() {
    let fixture = load("product/daemon/stage136_vless_vmess_xhttp_http2_lifecycle_gate.json");
    let contract = stage136_vless_vmess_xhttp_http2_gate_contract();
...
#[test]
fn stage136_vless_vmess_xhttp_http2_admits_only_subrows() {
    let contract = stage136_vless_vmess_xhttp_http2_gate_contract();
