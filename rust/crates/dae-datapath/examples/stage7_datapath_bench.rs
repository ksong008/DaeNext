...
mod dae_dataline_bench {
    ...
    pub fn bench_magic_network(iters: u64) {
        ...
        println!("stage7_magic_network_mark_mptcp_ns_per_op={ns_per_op:.1}");
    }
    ...
    pub fn bench_udp_trim(iters: u64) {
        ...
        let ns_per_op = started.elapsed().as_nanos() as f64 / iters as f64;
        println!("stage7_udp_endpoint_trim_target_ns_per_op={ns_per_op:.1}");
    }
}
...
fn main() {
    ...
    eprintln!(
        "stage7_datapath_bench_elapsed_ms={}",
