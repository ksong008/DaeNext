...
pub(crate) fn parse_runtime_owner_arg<'a>(
    ...
    match arg {
        ...
        "--production-runtime-native-ebpf" => {
            state.production_runtime_native_ebpf_opt_in = true;
        }
        ...
        "--production-runtime-fallback-retirement-product-chain-recertified" => {
            state.production_runtime_fallback_retirement_product_chain_recertified = true;
        }
        "--production-runtime-fallback-retirement-explicit-approval" => {
            state.production_runtime_fallback_retirement_explicit_user_approval = true;
        }
        _ => return Ok(false),
    }
    Ok(true)
