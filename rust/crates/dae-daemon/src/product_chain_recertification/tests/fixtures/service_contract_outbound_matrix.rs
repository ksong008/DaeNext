...
pub(crate) fn insert_outbound_matrix_and_source_contract(
    ...
    report.insert(
        ...
        json!({
            ...
            "source_supported_row_count": 21,
            "admitted_row_count": 20,
            "explicit_fail_closed_row_count": 1,
            "all_source_supported_rows_admitted": false,
            "all_protocol_rows_open": false,
            "official_common_source_shape_total": 21,
            "admitted_official_common_source_shape_count": 20,
            "explicit_fail_closed_official_common_source_shape_count": 1,
            ...
            "blocked_protocol_variant_count": 1,
            "blocked_protocol_variant_ids": ["reality-security-underlay"],
            "explicit_fail_closed_shape_ids": ["reality-security-underlay"],
