...
pub(crate) fn insert_evidence_sections(
    ...
    report.insert(
        ...
        json!({
            ...
            "invalid_config_rollback_verified": context.evidence.reload_runtime.invalid_config_rollback_verified.clone(),
            ...
            "rollback": context.evidence.reload_runtime.rollback.clone(),
