...
pub(super) fn udp_dns_datapath_contract_json() -> Value {
    json!({
        ...
        "source_of_truth": [
            ...
            "DAEX_RUST_REBUILD_PLAN_2026-05-16.md:stage14-ebpf-tproxy-netns-active-datapath",
            "DAENEW_RUST_REBUILD_MEMO_2026-05-16.md:5.6-udp-path",
            "DAENEW_RUST_REBUILD_MEMO_2026-05-16.md:10.5-dns-controller-request-response"
        ],
        "global_hard_rule": {
            ...
            "required_standard": "Go daenew generic parser optimizer matcher DNS datapath contract plus golden fixtures and rule matrix"
        },
        "udp": {
        ...
        "dns": {
            ...
            "required_semantics": [
                ...
                "asis allowed only where Go allows it",
        ...
        "runtime_admission": {
            ...
            "go_fallback_required_until_admitted": true,
            "default_switch_allowed_by_this_contract": false
        }
    })
}
...
mod tests {
    ...
    fn generic_contract_rejects_test_config_as_implementation_standard() {
        ...
        assert!(
            contract["runtime_admission"]["go_fallback_required_until_admitted"]
                .as_bool()
                .unwrap()
        );
    }
